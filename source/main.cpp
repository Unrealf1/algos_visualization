...
int main(int argc, char** argv) {
    ...
    auto display_width = 620;
    auto display_height = 620;
    ...
    visual::Grid grid(width, height, display_width, display_height);
    ...
    auto progress_timer = visual::Timer(8.0 / double(search_log.size()));
